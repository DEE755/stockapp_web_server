...
try {
  ...
  res.json({success: true, message: 'Followset added successfully', back_id: followsetId});// return the id of the followset created so the front can use it to updateand sync the followset
}
